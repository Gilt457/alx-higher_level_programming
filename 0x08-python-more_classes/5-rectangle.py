...
class Rectangle:
    ...
    @property
    def width(self):
        """This property gets/sets the width of the rectangle."""
        return self.__width
    ...
    @property
    def height(self):
        """This property gets/sets the height of the rectangle."""
    ...
    def __repr__(self):
        """This method returns a formal representation of the rectangle."""
        return "Rectangle({}, {})".format(self.__width, self.__height)

    def __del__(self):
        """This method prints a message when a rectangle is deleted."""
        print("Bye rectangle...")
